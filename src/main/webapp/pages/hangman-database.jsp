...
<head>
	...
	<title>Hangman - Database Mode</title>
...
<body>
	...
	<script src="${ctx}/scripts/hangman-database.js"></script>
	<script type="text/javascript">
		$(function() {
			...
			$('[data-hangman-letter]').click(function() {
				...
				hangman.guess($('[data-hangman-token="true"]').val(),letter, callbacks);
			});
			...
			$('[data-hangman-load]').click(function() {
				...
				consoleUtils.log('load game, token: ['+token+']');
