...
public final class Guess implements Comparable<Guess>, Serializable {
	private static final long serialVersionUID = 1342678114665222255L;
	 ...
	 * @return
	 */
	public static Guess newFor(char value) {
	...
	public int compareTo(Guess other) {
		char otherLwrLetter = other!=null ? 
				Character.toLowerCase(other.getValue()) : 
				Character.MIN_VALUE;
